...
$isp_street_address = get_field('isp_street_address', 'option');
$isp_city_stat_zip = get_field('isp_city_stat_zip', 'option');
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h1 class="h2 text-uppercase color-white f-900 my-3">Terms & Conditions</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="body">
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-12">
                <p>
                    Thank you for visiting our website (<a class="color-secondary color-primary-hover" rel="noopener noreferrer" href="https://<?php echo $domain_url; ?>"><?php echo $domain_url; ?></a>) hereinafter referred to as “Website,” “website,” or “Site.”
                    <br><br>
                    If you are visually-impaired, we recommend using text-to-speech software, to enjoy our website. If you need help using our site, please email us at <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a>.
                    <br><br>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Terms and Conditions of Use</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Our Website’s Privacy Policy is Part of These Terms and Conditions</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Video and Audio Content</h3>

                <p>The website (<a class="color-secondary color-primary-hover" rel="noopener noreferrer" href="https://<?php echo $domain_url; ?>"><?php echo $domain_url; ?></a>) may contain one or more videos and/or audio recordings (individually and collective hereinafter referred to as the “Recordings”). This section describes our respective rights and responsibilities with regard to the Recordings.</p>

                <h3 class="text-uppercase mt-4 mb-2">Recordings Are for Entertainment and Informational Purposes Only</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Embedded Recordings from External Social Media Sites Not Owned by Us</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Embedded Recordings Owned by Us and Hosted on Our Servers or Third Party Servers Excluding Third Party Social Media Sites</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Personal Non-Exclusive Revocable Non-Transferrable License</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Broken or Obsolete Recordings</h3>

                <p>We review our website periodically for broken or out-of-date Recordings. Any and all Recordings may be posted, altered, or removed at any time. To report problems with Recordings on our website, or for more information, please send an email to <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a>.</p>

                <h3 class="text-uppercase mt-4 mb-2">Licensee Status</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Content Ownership</h3>
                ...
                <p>
                    ...
                    <br><br>
                    You agree not to copy content from our website without our permission. Any requests to use our content should be submitted to us by email to <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a>.
                    <br><br>
                    If you believe that your intellectual property rights have been infringed upon by our website content, please notify us by sending an email to <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a>, or by sending postal mail to us at the address listed below. Please describe in detail the alleged infringement, including the factual and legal basis for your claim of ownership.
                    <br><br>
                    For copyright infringement issues, please follow the instructions in the DMCA Notice found below on this web page
                </p>

                <h3 class="text-uppercase mt-4 mb-2">Mobile Apps</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Disclaimers And Limitations of Liability</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Cyber-Bullying and Internet Harassment</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Posted and Submitted Content</h3>

                <p>
                    If you post content on or submit content to our website (e.g. photos, reviews, comments, etc.), you represent that you have the legal right to share such content on our website, the content is accurate, and it does not violate the law or these terms and conditions of use.
                    <br><br>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Agreement Between Us</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Severability Of These Terms, Conditions, And Policies</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">How To Contact Us</h3>

                <p>
                    Any questions or concerns about these terms, conditions, and policies should be brought to our attention by email to <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a>, and providing us with information relating to your concern.
                    <br><br>
                    You may also mail your concerns to us at the following address:
                    <br><br>
                    <?php if (!empty($brand_name)) { ?>
                        <?php echo $brand_name; ?><br>
                    <?php } ?>
                    <?php echo $address_line_1; ?><br>
                    <?php echo $city_state_zip; ?><br>
                    <?php echo $entity_country; ?>
                </p>

                <h3 class="text-uppercase mt-4 mb-2">Entire Agreement</h3>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Modifications and Termination</h3>
                ...
                <p>
                    ...
                    <br><br>
                    If you are concerned about these terms, conditions, and policies, you should read them each time before you use our website. Any questions or concerns should be brought to our attention by sending an email to <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:<?php echo $email_address; ?>"><?php echo $email_address; ?></a> and providing us with information relating to your concern.
                    <br><br>
                    These terms, conditions, and policies were last updated on <?php echo $update_date; ?>.
                </p>

                <h3 class="text-uppercase mt-4 mb-2">Digital Millennium Copyright Act (“DCMA”) Notice</h3>

                <p>
                    This notice is for informational purposes only. It is not intended as, nor should it be construed as, legal advice. If you believe that your intellectual property rights have been infringed upon, or if a notice of infringement has been filed against you, you should immediately seek legal counsel.
                    <br><br>
                    This website, including all text, HTML, scripts, and images are copyrighted, owned, and/or licensed by <a class="color-secondary color-primary-hover" rel="noopener noreferrer" href="https://<?php echo $domain_url; ?>"><?php echo $domain_url; ?></a>. All rights reserved.
                    <br><br>
                ...
                <h3 class="text-uppercase mt-4 mb-2">DMCA Provisions</h3>
                ...
                <h3 class="text-uppercase mt-4">Notification of Claimed Copyright Infringement</h3>

                <h3 class="text-uppercase mt-3 mb-2">
                ...
                <p>
                    <?php if ($ms_hosting) { ?>
                        WPEngine<br>
                        504 Lavaca Street, Suite 1000<br>
                        Austin, TX 78701<br>
                        USA<br>
                        <a class="color-secondary color-primary-hover" target="_blank" rel="noopener noreferrer" href="mailto:sales@wpengine.com">sales@wpengine.com</a><br>
                        <a class="color-secondary color-primary-hover" href="tel:877-973-6446">877-973-6446</a>
                    <?php } else { ?>
                        <?php echo $isp_name; ?><br>
                        <?php echo $isp_street_address; ?><br>
                ...
                <h3 class="text-uppercase mt-4 mb-2">Counternotification to Claimed Copyright Infringement</h3>
