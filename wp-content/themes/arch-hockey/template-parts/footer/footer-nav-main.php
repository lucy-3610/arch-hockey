...
/**
 * The template for displaying the footer main navigation
 */
...
<?php if (have_rows('footer_menu_item', 'option')) : // Repeater

    while (have_rows('footer_menu_item', 'option')) : the_row(); // Main Footer Menu
                    ...
                    <div class="w-100">
                        ...
                        <?php else : ?>
                            <a href="<?php if ($link_type == 'Select Link') : echo $select_link;
                                        ...
                                        endif; ?>" class="position-relative color-white anchor-primary-hover anchor-primary-active<?php if (!empty($add_class)) : echo ' ' . $footer_menu_class;
                                                                                                                                    endif; ?>">
                                <?php echo $menu_title; ?>
                            </a>
                        <?php endif; ?>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            ?>
                                                ...
                                                <li class="sub-menu-item">
                                                    <div class="d-flex justify-content-center justify-content-lg-start align-items-center my-1">
                                                        <span class="color-primary">
                                                            <i class="fa-solid fa-football mx-2"></i>
                                                        </span>
                                                        <a href="<?php if ($sub_menu_link_type == 'Select Link') : echo $sub_menu_select_link;
                                                                    else : echo $sub_menu_custom_link;
                                                                    endif; ?>" <?php if ($new_window) : ?>target="_blank" <?php endif; ?> class="anchor-tertiary anchor-primary-hover anchor-primary-active<?php if (!empty($add_class)) : echo ' ' . $footer_menu_class;
                                                                                                                                                                                                            endif; ?>">
