...
function theme_enqueue_styles()
{
    ...
    wp_enqueue_style('slick-style', get_stylesheet_directory_uri() . '/assets/slick-1.8.1/slick/slick.css');

    wp_enqueue_style('slick-theme-style', get_stylesheet_directory_uri() . '/assets/slick-1.8.1/slick/slick-theme.css');
    // Hover CSS
    //wp_enqueue_style( 'hover-style', get_stylesheet_directory_uri() . '/assets/css/hover.css' );
