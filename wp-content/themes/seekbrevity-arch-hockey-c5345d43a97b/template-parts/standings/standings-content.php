...
Template part for displaying content on the standings archive.
...
<article id="post-<?php the_ID(); ?>" <?php post_class('standings-archive-post'); ?>>
	...
	<header class="post-header">
		<h6 class="post-sub-title">Standings</h6>
		<h2 class="post-title">
	...
	<a class="button" href="<?php the_permalink(); ?>">View Standings</a>
