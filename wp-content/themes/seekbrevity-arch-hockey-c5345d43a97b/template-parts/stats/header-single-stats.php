...
if ($thumb_id) {
	...
	$thumb_id = get_field('stats_ahi','options');
...
<header id="single-stats-header" class="page-header-wrapper wrapper" <?php if($thumb_id) {?>style="background-image: url('<?php echo $thumb_url[0]; ?>');" <?php } ?>>
