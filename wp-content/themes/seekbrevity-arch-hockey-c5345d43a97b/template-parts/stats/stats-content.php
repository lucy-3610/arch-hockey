...
Template part for displaying content on the stats archive.
...
<article id="post-<?php the_ID(); ?>" <?php post_class('stats-archive-post'); ?>>
	...
	<header class="post-header">
		<h6 class="post-sub-title">Stats</h6>
		<h2 class="post-title">
	...
	<a class="button" href="<?php the_permalink(); ?>">View Player Stats</a>
